                ...
                axios.get("https://localhost:5000/users/logins").then((req) => {
                    if (req.data.includes(login)) {
                        ...
                        axios
                            ...
                            .then((res) => {
                                if (res.data === true) {
                                    Cookies.set("BlockedRegister", parseInt(amountOfRegister) + 1, {
    ...
    return (<div className={"login"}>
        <div className={"form"}>
            ...
            >
                ...
                >
                    <Button variant={"text"} onClick={() => history.push("/")}>Powrót</Button>
                    <Button variant={"contained"} onClick={() => handleRegister()}>Zarejstruj się</Button>
                </Stack>
            </Box>
            <Snackbar
                open={open}
